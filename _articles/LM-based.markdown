...
<span class="snippet"><span>Comment</span>A wide variety of NLP applications, such as machine translation, summarization, and dialog, involve text generation. One major challenge for these apB ...</span>
...
<span class="snippet"><span>Comment</span>We frame the task of machine translation evaluation as one of scoring machine translation output with a sequence-to-sequence paraphraser, conditionedP ...</span>
